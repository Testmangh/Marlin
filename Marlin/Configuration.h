...
#define STRING_CONFIG_H_AUTHOR "(Robim, Ender-3 Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 Pro SKR 1-3"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKi 9.15
  #define DEFAULT_bedKd 442.19
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80.40, 399.69, 92.89 }
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { {  38, 4, (Z_MIN_POS + 4) } }
  #define NOZZLE_CLEAN_END_POINT   { { 66, 10, (Z_MIN_POS + 4) } }
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN     P1_26       // LED driving pin
